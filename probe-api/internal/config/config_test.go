...
func TestLoadValidatesAgentInstallerURL(t *testing.T) {
	for _, value := range []string{
		...
		"https://raw.githubusercontent.com/Kcmose/my-agent/refs/tags/v1.0.3/deploy/install.sh",
		"https://raw.githubusercontent.com/Kcmose/my-agent/refs/tags/v2.0.0/deploy/install.sh",
		"https://raw.githubusercontent.com/Kcmose/my-agent/refs/tags/v1.0.2-beta/deploy/install.sh",
		"https://raw.githubusercontent.com/Kcmose/my-agent/refs/tags/v1.0.2+build/deploy/install.sh",
		"https://raw.githubusercontent.com/Kcmose/my-agent/refs/tags/v999999999999999999999.0.0/deploy/install.sh",
		"https://raw.githubusercontent.com/Kcmose/my-agent/refs/heads/v1.0.2/deploy/install.sh",
